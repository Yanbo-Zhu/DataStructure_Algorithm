...
Speicherkomplexität
- analog zu Zeitkomplexität:
	- Anzahl der benötigten Speicherwörter in Abhängigkeit der Eingabe
- Notwendigkeit für Speicher für Eingabe ist klar
- aber braucht der Algorithmus noch mehr Speicher?
	- nur zusätzlicher konstanter Speicher -> arbeitet in-place
	- bei dynamischen Speicherplatzbedarf wieder Unterteilung in worst, average und best case
